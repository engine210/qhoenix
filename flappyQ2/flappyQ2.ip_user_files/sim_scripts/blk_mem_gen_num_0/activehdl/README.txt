...
#
# Generated by export_simulation on Tue Dec 31 19:34:48 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_num_0.sh' script.

./blk_mem_gen_num_0.sh -reset_run
...
./blk_mem_gen_num_0.sh -noclean_files

For more information on the script, please type './blk_mem_gen_num_0.sh -help'.
