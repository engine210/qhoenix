...
#
# Generated by export_simulation on Tue Dec 31 19:54:04 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_num_8.sh' script.

./blk_mem_gen_num_8.sh -reset_run
...
./blk_mem_gen_num_8.sh -noclean_files

For more information on the script, please type './blk_mem_gen_num_8.sh -help'.
