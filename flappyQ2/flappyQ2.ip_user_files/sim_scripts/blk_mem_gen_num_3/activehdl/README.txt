...
#
# Generated by export_simulation on Tue Dec 31 19:39:09 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_num_3.sh' script.

./blk_mem_gen_num_3.sh -reset_run
...
./blk_mem_gen_num_3.sh -noclean_files

For more information on the script, please type './blk_mem_gen_num_3.sh -help'.
