...
#
# Generated by export_simulation on Tue Dec 31 19:44:16 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_num_5.sh' script.

./blk_mem_gen_num_5.sh -reset_run
...
./blk_mem_gen_num_5.sh -noclean_files

For more information on the script, please type './blk_mem_gen_num_5.sh -help'.
